...
const menuByRole: Record<string, { icon: React.ElementType; label: string; href: string; tooltip: string; end?: boolean }[]> = {
  ...
  professor: [
    ...
    { icon: ClipboardCheck,  label: 'Frequência',          href: '/dashboard/frequencia',            tooltip: 'Planilha de chamada (alunos × datas) — tela cheia' },
  ...
  administracao: [
    ...
    { icon: ClipboardCheck,  label: 'Frequência',      href: '/dashboard/frequencia',        tooltip: 'Planilha de chamada (alunos × datas)' },
    { icon: Star,            label: 'Notas',           href: '/dashboard/painel-academico',  tooltip: 'Grade de notas da turma (alunos × N1/N2)' },
