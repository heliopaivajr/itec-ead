...
| R3 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | 🔵 próximo — **REDEFINIDO como FRONTEND** (não-RLS). Diagnóstico R3.0 (2026-06-30): RLS de `notas_aluno` **já completa** (023/031, F3 ✅); refinamento professor-por-contrato adiado (F2). Sub-passos: **R3.1 AlunoView ✅** (KPIs reais cursos/freq/média + progresso; hook `useAlunoDashboard` reusa fontes do Meu Histórico; PR #21 merged) · **R3.2 ProfessorView 🔵 próximo** (dados reais: turmas/alunos/avaliações) · **R3.3 Painel da Secretaria** (pendências: matrículas a aprovar + docs) · **R3.4 Ficha 360** (convalidação + nº matrícula na ficha). Polir navy #1F3864 / dourado #BF9000. |
| R4 | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ |
